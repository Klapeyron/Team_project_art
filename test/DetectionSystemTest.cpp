...
TEST (DetectionSystemTest, enemyCardTakenTest_customSize)
{
  ...
  TableSnapshot output;
  output.playerCards.emplace_back(Card_Figure::THREE, Card_Color::HEART);
  output.playerCards.emplace_back(Card_Figure::FIVE, Card_Color::HEART);
  ...
  output.playerCards.emplace_back(Card_Figure::NINE, Card_Color::DIAMOND);

  output.playerCards.emplace_back(Card_Figure::A, Card_Color::SPADE);
  output.playerCards.emplace_back(Card_Figure::TEN, Card_Color::SPADE);
  output.playerCards.emplace_back(Card_Figure::JACK, Card_Color::SPADE);
